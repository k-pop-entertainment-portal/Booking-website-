/* ------------------------------------------------------------------
   Complete official Google Translate language catalog.
   English is the portal's default (source) language.
------------------------------------------------------------------- */
...
export const LANGUAGES: Lang[] = [
  ...
  { code: "ku", name: "Kurdish (Kurmanji)", native: "Kurmancî" },
...
/** Popular languages surfaced at the top of the picker. */
export const POPULAR = [
  "en", "ko", "ja", "zh-CN", "es", "fr", "pt", "ar", "hi", "id", "ru", "de", "vi", "th", "tl",
];
